...
"""autogenerated by genpy from cartesian_impedance_msgs/ConfigureForceControlRequest.msg. Do not edit."""
import codecs
import sys
...
class ConfigureForceControlRequest(genpy.Message):
  _md5sum = "378a2ac871ec6ade92b189f4ab145964"
  _type = "cartesian_impedance_msgs/ConfigureForceControlRequest"
...
float64 stiffness
"""
  __slots__ = ['cart_impedance_params','cart_force_control']
  _slot_types = ['cartesian_impedance_msgs/SetCartesianImpedance','cartesian_impedance_msgs/SetCartesianForceCtrl']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       cart_impedance_params,cart_force_control
    ...
    """
    if args or kwds:
      super(ConfigureForceControlRequest, self).__init__(*args, **kwds)
      ...
      if self.cart_force_control is None:
        self.cart_force_control = cartesian_impedance_msgs.msg.SetCartesianForceCtrl()
    else:
      self.cart_impedance_params = cartesian_impedance_msgs.msg.SetCartesianImpedance()
      self.cart_force_control = cartesian_impedance_msgs.msg.SetCartesianForceCtrl()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.cart_force_control.DOF
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.cart_force_control.force, _x.cart_force_control.stiffness))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.cart_force_control.DOF = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.cart_force_control.DOF = str[start:end]
      _x = self
      start = end
      end += 16
      (_x.cart_force_control.force, _x.cart_force_control.stiffness,) = _get_struct_2d().unpack(str[start:end])
      return self
...
def _get_struct_2d():
    ...
    return _struct_2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cartesian_impedance_msgs/ConfigureForceControlResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ConfigureForceControlResponse(genpy.Message):
  _md5sum = "c7c9cad7cd84b46126e20e34f547cde8"
  _type = "cartesian_impedance_msgs/ConfigureForceControlResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','cartesian_impedance_msgs/CartesianForceCtrlErrorCodes']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConfigureForceControlResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.success is None:
        self.success = False
      if self.error is None:
        self.error = cartesian_impedance_msgs.msg.CartesianForceCtrlErrorCodes()
    else:
      self.success = False
      self.error = cartesian_impedance_msgs.msg.CartesianForceCtrlErrorCodes()
...
def _get_struct_B():
    ...
    return _struct_B
class ConfigureForceControl(object):
  _type          = 'cartesian_impedance_msgs/ConfigureForceControl'
  _md5sum = 'cf3ce9f3d61d188954ed294028d91e13'
  _request_class  = ConfigureForceControlRequest
  _response_class = ConfigureForceControlResponse
