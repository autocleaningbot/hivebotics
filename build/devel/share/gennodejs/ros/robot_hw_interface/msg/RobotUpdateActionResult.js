...
let RobotUpdateResult = require('./RobotUpdateResult.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class RobotUpdateActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new RobotUpdateResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotUpdateResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotUpdateActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = RobotUpdateResult.Resolve(msg.result)
    }
    else {
      resolved.result = new RobotUpdateResult()
    }
...
module.exports = RobotUpdateActionResult;
