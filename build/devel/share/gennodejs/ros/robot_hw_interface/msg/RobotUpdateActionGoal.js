...
let RobotUpdateGoal = require('./RobotUpdateGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class RobotUpdateActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotUpdateGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotUpdateActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RobotUpdateGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RobotUpdateGoal()
    }
...
module.exports = RobotUpdateActionGoal;
