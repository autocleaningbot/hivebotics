...
(cl:defclass <abluoTelemetry> (roslisp-msg-protocol:ros-message)
  ((lin_act_pos
    :reader lin_act_pos
    :initarg :lin_act_pos
    :type cl:float
...
(cl:defclass abluoTelemetry (<abluoTelemetry>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <abluoTelemetry>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'abluoTelemetry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name abluo_control-msg:<abluoTelemetry> is deprecated: use abluo_control-msg:abluoTelemetry instead.")))

(cl:ensure-generic-function 'lin_act_pos-val :lambda-list '(m))
(cl:defmethod lin_act_pos-val ((m <abluoTelemetry>))
...
(cl:defmethod lin_act_vel-val ((m <abluoTelemetry>))
...
(cl:defmethod joint_pos-val ((m <abluoTelemetry>))
...
(cl:defmethod joint_vel-val ((m <abluoTelemetry>))
  ...
  (joint_vel m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <abluoTelemetry>) ostream)
  "Serializes a message object of type '<abluoTelemetry>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <abluoTelemetry>) istream)
  "Deserializes a message object of type '<abluoTelemetry>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<abluoTelemetry>)))
  "Returns string type for a message object of type '<abluoTelemetry>"
  "abluo_control/abluoTelemetry")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'abluoTelemetry)))
  "Returns string type for a message object of type 'abluoTelemetry"
  "abluo_control/abluoTelemetry")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<abluoTelemetry>)))
  "Returns md5sum for a message object of type '<abluoTelemetry>"
  "be46fb345c061067c53d8d4d84c44a87")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'abluoTelemetry)))
  "Returns md5sum for a message object of type 'abluoTelemetry"
  "be46fb345c061067c53d8d4d84c44a87")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<abluoTelemetry>)))
  "Returns full string definition for message of type '<abluoTelemetry>"
  (cl:format cl:nil "float32 lin_act_pos #val~%float32 lin_act_vel~%float32[6] joint_pos #degrees~%float32[6] joint_vel #deg/s~%# time startSyncTime~%# uint32 isrTicks # this would overflow if the robot is left on for 497 days straight at 100hz~%# uint8 bufferHealth~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'abluoTelemetry)))
  "Returns full string definition for message of type 'abluoTelemetry"
  (cl:format cl:nil "float32 lin_act_pos #val~%float32 lin_act_vel~%float32[6] joint_pos #degrees~%float32[6] joint_vel #deg/s~%# time startSyncTime~%# uint32 isrTicks # this would overflow if the robot is left on for 497 days straight at 100hz~%# uint8 bufferHealth~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <abluoTelemetry>))
  (cl:+ 0
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <abluoTelemetry>))
  "Converts a ROS message object to a list"
  (cl:list 'abluoTelemetry
