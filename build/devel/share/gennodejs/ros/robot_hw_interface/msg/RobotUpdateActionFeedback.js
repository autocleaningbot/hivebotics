...
let RobotUpdateFeedback = require('./RobotUpdateFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class RobotUpdateActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RobotUpdateFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotUpdateFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotUpdateActionFeedback(null);
    ...
    data.feedback = RobotUpdateFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotUpdateActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RobotUpdateFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RobotUpdateFeedback()
    }
...
module.exports = RobotUpdateActionFeedback;
